"""Production settings for loyalty_system project."""
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-fallback-key-for-build-only')
...
# Database
# Production database configuration (SQLite)
DATABASES = {
    'default': {
...
CHECKBOX_ALTERNATIVE_URLS = [
    'https://api.checkbox.in.ua/api/v1',
    'https://dev-api.checkbox.in.ua/api/v1',
